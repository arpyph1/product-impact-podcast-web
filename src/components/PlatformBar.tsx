...
export default function PlatformBar({ content, isEditing }: PlatformBarProps) {
  return (
    <section id="platforms" className="bg-background">
        ...
        <div className="grid grid-cols-3 divide-x divide-border border-b border-border">
          {PLATFORMS.map(p => (
            <a
              ...
              className="group flex items-center justify-between gap-3 px-6 py-7 hover:bg-card transition-colors"
            >
